...
anomaly_data = pd.read_csv('anomaly_detection\preprocessed_anomaly_data.csv')
normal_data = pd.read_csv('anomaly_detection\preprocessed_normal_data.csv')


example_input = pd.read_csv('data\исходные данные от оператора\\023T0569\log(336804727)[26-03-2024_16-11-37] 01.07-01.08.csv', sep=';').iloc[193]
try:
